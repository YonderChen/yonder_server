...
public class CommandRouter {
    ...
    private static Map<Short,ICommand> handlerServiceMap = new HashMap<Short,ICommand> ();//new ConcurrentHashMap<Short,HandlerService> ();
     ...
     * @return 
     */
    public static ICommand getHandlerService(Short handlerId){
     ...
     */
    public static void register(short handlerId,ICommand handlerService){
        if(handlerServiceMap.containsKey(handlerId)){
