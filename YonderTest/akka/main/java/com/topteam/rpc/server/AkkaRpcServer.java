...
public class AkkaRpcServer {
	...
	public AkkaRpcServer() {
		...
		this.port = "9911";
		this.akkaSystemName = "EsbSystem";
		this.seedNodes = new ArrayList<String>();
		this.seedNodes.add("127.0.0.1:9911");
//		this.seedNodes.add("127.0.0.1:2551");
//		this.seedNodes.add("127.0.0.1:2552");
	}

	public static void main(String[] args) {
		new AkkaRpcServer().start();
	}
	...
	public void start() {
		final Config config = ConfigFactory
				...
				.withFallback(
						ConfigFactory
								.parseString("akka.cluster.roles = [RpcServerRoot]"));
		...
		system.actorOf(Props.create(RpcServerRootActor.class), "rpcServerRoot");
	}
