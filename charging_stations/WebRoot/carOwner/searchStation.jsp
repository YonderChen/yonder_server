...
<head>
    ...
    <script src="http://ditu.google.cn/maps?file=api&amp;v=3&amp;key=AIzaSyBGIK4Ru36GpGGLuV9TnFQtCtkL2uv6UGY&hl=zh-CN" type="text/javascript"></script>
</head>
<body onunload="GUnload()">
    ...
    <script type="text/javascript">
        $(function () {
			...
			loadPageContent("carOwner", menuid);
        });
    </script>
</body>
</html>
