...
function add() {
	...
	if (!isTelephone($("#phone_a").val().trim())) {
		alert("手机号码无效");
		$("#phone_a").select();
		return;
	}
		...
		<div class="rightinfo">
			<ul class="seachform">
				...
				<li>
					...
					<input name="username" id="username" type="text" class="span2" />
				</li>
				<li>
					<label>
						姓名:
				...
				<li>
					...
					<input name="phone" id="phone" type="text" class="span2" />
				</li>
				<li>
					<label>
						&nbsp;
					</label>
					<button id="searchBtn" class="btn btn-info" onclick="ajaxSearch(1);" data-toggle="button" data-loading-text="<i class='icon-search'></i>&nbsp;搜索中...">
			...
			<div class="tools">
				<ul class="seachform">
					<li>
						<button class="btn btn-primary" type="button" onclick="addInput();" data-toggle="button" data-loading-text="<i class='icon-plus'></i>&nbsp;新增用户">
