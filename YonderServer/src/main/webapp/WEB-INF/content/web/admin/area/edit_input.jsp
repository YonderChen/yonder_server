...
<table width="100%" border="1">
  ...
  <tr>
    ...
    <td><input type="text" class="span2" maxlength="100" value="${area.host }:${area.port }" placeholder="IP地址:端口" readonly/>
    </td>
  </tr>
  <tr>
    <td align="right">Akka(IP地址:端口) <em class="text-error"  style="font-size:16px">*</em>：</td>
    <td><input type="text" class="span2" maxlength="100" value="${area.hostLan }:${area.portLan }" placeholder="IP地址:端口" readonly/>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input type="text" class="span2" value="${area.version }" placeholder="版本号" readonly/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input type="text" class="span2" value="${area.groupBy }" placeholder="合服编号" readonly/></td>
  </tr>
  <tr>
    <td align="right" style="padding-top:5px;">是否QA<em class="text-error"  style="font-size:16px">*</em>：</td>
    <td><label class="radio inline"><input disabled type="radio" value="0" name="isQa_e" <s:if test="#request.area.isQa == 0">checked</s:if>/>否</label>
    	<label class="radio inline"><input disabled type="radio" value="1" name="isQa_e" <s:if test="#request.area.isQa == 1">checked</s:if>/>是</label>
    </td>
  </tr>
  <tr>
