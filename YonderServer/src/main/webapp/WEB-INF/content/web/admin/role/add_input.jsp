...
<table width="100%" border="1">
  <tr>
    ...
    <td><input name="name_a" id="name_a" type="text" class="span2" value="" placeholder="角色名称" maxlength="50"/></td>
  </tr>
  <tr>
    <td align="right">角色描述<em class="text-error"  style="font-size:16px">*</em>：</td>
    <td>
