...
<table width="100%" border="1">
  <tr>
    ...
    <td><input name="username_a" id="username_a" type="text" class="span2" value="" placeholder="用户名"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input name="phone_a" id="phone_a" type="text" class="span2" maxlength="20" value="" placeholder="手机号码"/></td>
  </tr>
  <tr>
